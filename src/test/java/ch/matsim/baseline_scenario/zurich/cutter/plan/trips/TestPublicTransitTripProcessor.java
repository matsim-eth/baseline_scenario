...
public class TestPublicTransitTripProcessor {
	...
	public void testPublicTransitTripProcessor() {
		...
		PublicTransitTripProcessor processor;
		...
		processor = new PublicTransitTripProcessor(finderMock, scenarioExtentMock, 1.0);
