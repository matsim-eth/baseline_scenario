...
public class BaselineLinkSpeedCalculator implements LinkSpeedCalculator {
	final private LinkSpeedCalculator delegate;
	final private double crossingPenalty;

	public BaselineLinkSpeedCalculator(LinkSpeedCalculator delegate, double crossingPenalty) {
