...
public class RunDeprecatedCountMapper {
	static public void main(String[] args) throws IOException {
		...
		if (mode.equals("daily")) {
			Collection<DailyCountItem> countItems = new DeprecatedDailyReferenceCountsReader(deprecatedNetwork, ";")
					.read(deprecatedCountsInputPath);
			...
			Collection<HourlyCountItem> countItems = new DeprecatedHourlyReferenceCountsReader(deprecatedNetwork, ";")
					.read(deprecatedCountsInputPath);
			new CountNetworkMapper(deprecatedNetwork, currentNetwork).run(countItems);
